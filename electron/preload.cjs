...
contextBridge.exposeInMainWorld("sq", {
  ...
  setLemmyCredentials: (instanceUrl, accessToken) => ipcRenderer.invoke("cfg:setLemmyCredentials", { instanceUrl, accessToken }),
  ...
  testLemmyAuth: () => ipcRenderer.invoke("lemmy:auth:test"),
  lemmyLogout: () => ipcRenderer.invoke("lemmy:auth:logout"),
  fetchLemmyCommunities: (options) => ipcRenderer.invoke("lemmy:communities", options || {}),
  fetchLemmyCommunityInfo: (communityId) => ipcRenderer.invoke("lemmy:communityInfo", { communityId }),
  ...
  fetchGroupInfo: (groupId) => ipcRenderer.invoke("flickr:groupInfo", { groupId }),
  retryFlickrGroupAdditionsNow: () => ipcRenderer.invoke("flickr:retryGroupAdditionsNow"),
  ...
  queueDeleteOriginalsByIds: (payload) => ipcRenderer.invoke("queue:deleteOriginalsByIds", payload || {}),
  queueRemoveAndTrash: (ids) => ipcRenderer.invoke("queue:removeAndTrash", { ids }),
  queueGetMissingPathGroups: () => ipcRenderer.invoke("queue:getMissingPathGroups"),
  queueRelinkMissingFromFolder: (options) => ipcRenderer.invoke("queue:relinkMissingFromFolder", options || {}),
  ...
  pickFolder: () => ipcRenderer.invoke("ui:pickFolder"),
  ...
  setAfterUploadAction: (action) => ipcRenderer.invoke("cfg:setAfterUploadAction", { action }),
  ...
  setUseLargeFonts: (enabled) => ipcRenderer.invoke("cfg:setUseLargeFonts", { enabled }),
  setUseLightTheme: (enabled) => ipcRenderer.invoke("cfg:setUseLightTheme", { enabled }),
  ...
  setBlueskyImageResizeOptions: (payload) => ipcRenderer.invoke("cfg:setBlueskyImageResizeOptions", payload || {}),
  ...
  setPixelfedImageResizeOptions: (payload) => ipcRenderer.invoke("cfg:setPixelfedImageResizeOptions", payload || {}),
  setPixelfedUseDescriptionAsAltText: (enabled) => ipcRenderer.invoke("cfg:setPixelfedUseDescriptionAsAltText", { enabled }),
  setPixelfedMastodonReshareEnabled: (enabled) => ipcRenderer.invoke("cfg:setPixelfedMastodonReshareEnabled", { enabled }),
  setMastodonPostTextMode: (mode) => ipcRenderer.invoke("cfg:setMastodonPostTextMode", { mode }),
  setMastodonImageResizeOptions: (payload) => ipcRenderer.invoke("cfg:setMastodonImageResizeOptions", payload || {}),
  setMastodonUseDescriptionAsAltText: (enabled) => ipcRenderer.invoke("cfg:setMastodonUseDescriptionAsAltText", { enabled }),
  setLemmyPostTextMode: (mode) => ipcRenderer.invoke("cfg:setLemmyPostTextMode", { mode }),
  setLemmyImageResizeOptions: (payload) => ipcRenderer.invoke("cfg:setLemmyImageResizeOptions", payload || {}),
  ...
  setLemmyPrependText: (text) => ipcRenderer.invoke("cfg:setLemmyPrependText", { text }),
  setLemmyAppendText: (text) => ipcRenderer.invoke("cfg:setLemmyAppendText", { text }),
  ...
  setFlickrQueueNewUploadsBehindExistingGroupQueues: (enabled) => ipcRenderer.invoke("cfg:setFlickrQueueNewUploadsBehindExistingGroupQueues", { enabled }),
